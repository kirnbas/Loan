...
function () {
  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers() {
      var bind = function bind(officer, counter, items) {
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, activeClass, animate, autoplay, onlyChilds) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, activeClass, animate, autoplay, onlyChilds));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      if (this.autoplay) {
        // Helper lambda
        var bindMouseOverOut = function bindMouseOverOut(element) {
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$onlyChilds = _ref.onlyChilds,
      onlyChilds = _ref$onlyChilds === void 0 ? '' : _ref$onlyChilds;

  _classCallCheck(this, Slider);

  this.container = document.querySelector(container);
  this.slides = onlyChilds ? this.container.getElementsByClassName(onlyChilds) // Array.prototype.filter.call(this.container.children, s => s.classList.contains(onlyChilds)) 
